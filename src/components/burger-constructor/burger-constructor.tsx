...
function BurgerConstructor() {
    ...
    const { ingredients, bun } = useAppSelector(state => ({
        bun: state.userBurgerIngredients.bun,
        ingredients: state.userBurgerIngredients.ingredients,
    }));
    ...
    const handleOpenModal = async () => {
        if (localStorage.getItem('accessToken')) {
            dispatch(submitOrder(allFoodIds));
        } else {
            navigate('/login');
        }
    }
